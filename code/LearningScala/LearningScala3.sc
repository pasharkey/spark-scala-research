object LearningScala3 {
  ...
  toUpper("test")                                 //> res3: String = TEST
  
  def toUpperFunc( s: String, f: String => String) : String = {
  	    f(s)
  }                                               //> toUpperFunc: (s: String, f: String => String)String
  
  toUpperFunc("test", f => { f.toUpperCase})      //> res4: String = TEST
