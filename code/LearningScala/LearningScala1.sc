object LearningScala1 {
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = HelloThere!
  println(immutableHelloThere)                    //> HelloThere!
  val moreStuff = immutableHelloThere + "year"    //> moreStuff  : String = HelloThere!year
  ...
  val myPi: Float = 3.14159265f                   //> myPi  : Float = 3.1415927
  println(f"${myPi * 2}%.3f")                     //> 6.283
}